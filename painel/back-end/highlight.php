<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $sql = "UPDATE $tabela SET top_highlight_bar = :top_highlight_bar, top_highlight_bar_location = :top_highlight_bar_location, top_highlight_bar_text = :top_highlight_bar_text, center_highlight_images = :center_highlight_images WHERE id = :id";
