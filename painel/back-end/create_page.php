<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $sql = "INSERT INTO $tabela (shop_id, status, name, content, seo_name, seo_link, seo_description) VALUES 
                                    (:shop_id, :status, :name, :content, :seo_name, :seo_link, :seo_description)";
