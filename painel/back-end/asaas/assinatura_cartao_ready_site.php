<?php
function asaas_CriarAssinaturaCartaoReadySite($customer_id, $dataForm, $config) {
    include('config.php');
	...
	$fields = [
		...
		"nextDueDate" => isset($dataForm['nextDueDate']) ? date('Y-m-d', strtotime('+1 month')) : date('Y-m-d'),
		"value" => $dataForm["value"],
		"cycle" => $dataForm["period"],
		"description" => "Plano de assinatura Site Pronto",
		"creditCard" => [
