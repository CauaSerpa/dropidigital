...
function asaas_CriarCobrancaCartao($customer_id, $dataForm, $config) {
	...
	if($retorno['object'] == 'payment') {
        ...
        $stmt = $conn->prepare("INSERT INTO $tabela (shop_id, customer_id, payment_id, value, billing_type, status, start_date, due_date, cycle, credit_card_number, credit_card_flag) VALUES (
            :shop_id, :customer_id, :payment_id, :value, :billing_type, :status, :start_date, :due_date, :cycle, :credit_card_number, :credit_card_flag)");
