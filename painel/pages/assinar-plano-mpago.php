...
$sql = "SELECT name, email, docNumber, phone FROM $tabela WHERE id = :id";
                ...
                <div class="modal-body px-4 pb-3 pt-0">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="cep" id="cep" aria-describedby="cepHelp" value="<?php echo $address['cep']; ?>" onblur="getCepData()">
                        </div>
                        <div class="col-md-8">
            ...
            <div class="card mb-4 p-0">
                ...
                <div class="card-body px-4 py-3">
                    ...
                    <div class="user-data">
                        ...
                        <input type="hidden" name="cpf" value="<?php echo $user['docNumber']; ?>">
                        ...
                        <input type="hidden" name="number" value="<?php echo $address['numero']; ?>">
                        <input type="hidden" name="complement" value="<?php echo $address['complemento']; ?>">
                        <input type="hidden" name="district" value="<?php echo $address['bairro']; ?>">
