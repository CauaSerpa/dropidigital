    ...
    <div class="card mb-3 p-0">
        ...
        <div class="card-body row px-4 py-3">
            <div class="mb-3">
                ...
                <p class="small text-decoration-none" style="color: #01C89B;">https://dropidigital.com.br/servicos/<span class="fw-semibold" id="linkPreview">...</span></p>
            </div>
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div>
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="status" role="switch" id="activeService" value='1' checked>
                            <label class="form-check-label" id="activeCheckbox" for="activeService">Não</label>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    <div id="containerEmphasis">
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="emphasis" role="switch" id="emphasisService" value="1">
                            <label class="form-check-label" id="emphasisCheckbox" for="emphasisService">Não</label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="seo_link" id="textInput2" placeholder="link-do-servico" aria-label="link-do-servico" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                        <div class="d-flex justify-content-between">
                ...
                <div class="col-md-6">
                    ...
                    <div class="seo-preview p-3 rounded-2">
                        <h5 class="mb-0" id="textPreview1">Título do Serviço</h5>
                        <p class="text-decoration-none" style="color: #01C89B;">https://dropidigital.com.br/servicos/<span class="fw-semibold" id="textPreview2">...</span></p>
                        <p class="small" id="textPreview3">Descrição do Serviço</p>
                    </div>
                </div>
            </div>
        </div>
