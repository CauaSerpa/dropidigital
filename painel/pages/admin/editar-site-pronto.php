        ...
        <div class="header__title">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb align-items-center mb-3">
                    ...
                    <li class="breadcrumb-item fs-4 fw-semibold active" aria-current="page">Editar Site Pronto</li>
                </ol>
            </nav>
        </div>
    </div>
...
<form id="myForm" class="position-relative" action="<?php echo INCLUDE_PATH_DASHBOARD ?>back-end/admin/edit_ready_website.php" method="post" enctype="multipart/form-data">
    ...
    <div class="card mb-3 p-0">
        ...
        <div class="card-body row px-4 py-3">
            ...
            <?php
                ...
                $sql = "SELECT * FROM $tabela WHERE shop_id = :shop_id AND domain = :domain ORDER BY id DESC";
    ...
    <div class="card mb-3 p-0">
        ...
        <div class="card-body px-5 py-3">
            <label for="file-input-1" class="image-preview-container">
                <img src="<?= INCLUDE_PATH_DASHBOARD . 'back-end/admin/ready-website/' . $site['id'] . '/card-image/' . $site['card_image']; ?>" alt="Image Preview" class="image-preview <?= (isset($site['card_image'])) ? "d-block" : ""; ?>" id="image-preview-1">
                <div class="center-text <?= (isset($site['card_image'])) ? "d-none" : ""; ?>" id="text-1">
    ...
    <input type="radio" class="d-none" name="select" id="selectImage" value="image" <?= (isset($site['image'])) ? "checked" : ""; ?>>
    <input type="radio" class="d-none" name="select" id="selectVideo" value="video" <?= (isset($site['video'])) ? "checked" : ""; ?>>

    <div class="card mb-3 p-0 <?= (isset($site['image']) || isset($site['video'])) ? "d-none" : ""; ?>" id="select">
    ...
    <div class="card mb-3 p-0 <?= (!isset($site['image'])) ? "d-none" : ""; ?>" id="select-image">
        <div class="card-header d-flex justify-content-between fw-semibold px-4 py-3 bg-transparent">
            Upload da imagem
        ...
        <div class="card-body px-5 py-3">
            <div class="mb-1">
                <label for="file-input-2" class="image-preview-container">
                    <img src="<?= INCLUDE_PATH_DASHBOARD . 'back-end/admin/ready-website/' . $site['id'] . '/image/' . $site['image']; ?>" alt="Image Preview" class="image-preview <?= (isset($site['image'])) ? "d-block" : ""; ?>" id="image-preview-2">
                    <div class="center-text <?= (isset($site['image'])) ? "d-none" : ""; ?>" id="text-2">
                        <i class='bx bx-image fs-1'></i>
                        <p class="fs-5 fw-semibold">Faça upload da imagem aqui</p>
    ...
    <div class="card mb-3 p-0 <?= (!isset($site['video'])) ? "d-none" : ""; ?>" id="select-video">
        <div class="card-header d-flex justify-content-between fw-semibold px-4 py-3 bg-transparent">
            Adicionar vídeo
        ...
        <div class="card-body px-5 py-3">
            <div class="mb-1">
                ...
                <div class="position-relative">
                    ...
                    <input type="text" class="form-control icon-padding" name="video" id="video-url" placeholder="https://www.youtube.com/watch?v=000" aria-label="https://www.youtube.com/watch?v=000" value="<?php echo $site['video']; ?>">
                </div>
    ...
    <div class="card mb-3 p-0">
        ...
        <div class="card-body px-5 py-3">
            ...
            <textarea name="description" id="editor"><?php echo $site['description']; ?></textarea>
        </div>
    </div>
    ...
    <div class="card mb-3 p-0">
        ...
        <div class="card-body px-5 py-3">
            <div class="mb-3">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" name="sku" id="skuResult" placeholder="SKU" aria-label="SKU" aria-describedby="skuResult" style="max-width: 250px;" value="<?php echo $site['sku']; ?>">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="seo_name" id="textInput1" maxlength="70" aria-describedby="emailHelp" value="<?php echo $site['seo_name']; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="textInput2" class="form-label small">Link do Site Pronto</label>
                        <input type="text" class="form-control" name="seo_link" id="textInput2" placeholder="link-do-site-pronto" aria-label="link-do-site-pronto" aria-describedby="emailHelp" value="<?php echo $site['link']; ?>">
                    </div>
                    <div class="mb-3">
                        <div class="d-flex justify-content-between">
                        ...
                        <textarea class="form-control" name="seo_description" id="textInput3" maxlength="160" rows="3"><?php echo $site['seo_description']; ?></textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <label for="exampleInputEmail2" class="form-label small">Visualização</label>
                    <div class="seo-preview p-3 rounded-2">
                        <h5 class="mb-0" id="textPreview1"><?php echo $site['seo_name']; ?></h5>
                        <p class="text-decoration-none" style="color: #01C89B;">https://dropidigital.com.br/sites-prontos/<span class="fw-semibold" id="textPreview2"><?php echo $site['link']; ?></span></p>
                        <p class="small" id="textPreview3"><?php echo $site['seo_description']; ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <input type="hidden" name="shop_id" value="<?php echo $site['shop_id']; ?>">
...
<?php
    ...
    $stmtProductCategories->bindParam(':service_id', $site['id']);
...
<script>
    ...
    const emphasisReadyWebsite = document.getElementById("emphasisReadyWebsite");
    const emphasisCheckbox = document.getElementById("emphasisCheckbox");
    updateCheckboxText(emphasisReadyWebsite, emphasisCheckbox, "Sim", "Não");
</script>
...
<?php
    ...
    echo "É necessário selecionar um site pronto!";
}
?>