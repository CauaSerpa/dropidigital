...
<form id="myForm" class="position-relative" action="<?php echo INCLUDE_PATH_DASHBOARD ?>back-end/admin/create_article.php" method="post" enctype="multipart/form-data">
