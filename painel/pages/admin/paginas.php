<!-- https://www.youtube.com/embed/l8qW1XBi9yA?si=MADLOpXmSGypesWX -->
...
<div class="page__header center">
    <div class="header__title">
        ...
        <p class="shop-counter"><?php echo $countRoutes; echo ($countRoutes == 0 || $countRoutes == 1) ? ' página' : ' páginas'; ?></p>
    </div>
    <div class="header__actions">
        <div class="container__button">
            <a href="<?php echo INCLUDE_PATH_DASHBOARD; ?>back-end/admin/add-pages-in-routes.php" class="button button--flex align-items-center justify-content-center new text-decoration-none">
                <i class='bx bx-refresh fs-6 me-1'></i>
        ...
        ?>
                ...
                <table>
                    ...
                    if (!empty($_GET['search'])) {
                        ...
                        $sql .= " WHERE (name LIKE :searchTerm OR description LIKE :searchTerm OR url LIKE :searchTerm)";
                    }
                    ...
                    foreach ($routes as $route) {
                        ...
                        $route['url'] = INCLUDE_PATH_DASHBOARD . $route['page'];

                        echo '
                            <tbody>
                                <tr>
                                    <td scope="row">
                                        <input class="form-check-input itemCheckbox" type="checkbox" name="selected_ids[]" value="' . $route['id'] . '" id="defaultCheck2">
                                    </td>
                                    <td>' . $route['name'] . '</td>
                                    <td>' . $route['description'] . '</td>
                                    <td>' . $route['url'] . '</td>
                                    <td>
                                        <a href="' . INCLUDE_PATH_DASHBOARD . 'editar-pagina?id=' . $route['id'] . '" class="btn btn-primary">
