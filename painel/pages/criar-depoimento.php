...
<form id="myForm" class="position-relative" action="<?php echo INCLUDE_PATH_DASHBOARD ?>back-end/create_depositions.php" method="post" enctype="multipart/form-data">
        ...
        <div class="card-body row px-4 py-3">
            <div class="row">
                <div class="col-md-5 image-container">
                    ...
                    <small>
                        <b>DICA:</b> Você pode usar fotos de pessoas deste <a href="https://thispersondoesnotexist.com" target="_blank" class="text-reset">site</a>.
                    </small>
