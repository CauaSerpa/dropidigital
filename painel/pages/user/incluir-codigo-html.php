...
<form id="myForm" action="<?php echo INCLUDE_PATH_DASHBOARD ?>back-end/include_html.php" method="post">
        ...
        <div class="card-body row px-4 py-3">
            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    ...
                    <textarea class="form-control" name="script" id="script" maxlength="160" rows="3"></textarea>
