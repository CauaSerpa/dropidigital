...
<form id="myForm" class="position-relative" action="<?php echo INCLUDE_PATH_DASHBOARD ?>back-end/create_page.php" method="post" enctype="multipart/form-data">
    ...
    <div class="card mb-3 p-0">
        ...
        <div class="card-body px-5 py-3">
            ...
            <div class="mb-3">
                ...
                <p class="small text-decoration-none" style="color: #01C89B;">https://sua-loja.dropidigital.com.br/pagina/<span class="fw-semibold" id="linkPreview">...</span></p>
            </div>
            <div class="mb-3">
