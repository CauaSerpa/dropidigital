<?php
    ...
    $sql = "SELECT (whatsapp_group) FROM $tabela WHERE id = :id";
...
<div class="page__header center">
    ...
    <div class="header__actions">
        <div class="container__button">
            <a href="<?php echo INCLUDE_PATH_DASHBOARD; ?>ajuda/grupo-whatsapp" class="link-secondary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover text-decoration-none d-flex align-items-center">
...
<form id="myForm" class="position-relative" action="<?php echo INCLUDE_PATH_DASHBOARD ?>back-end/whatsapp_group.php" method="post" enctype="multipart/form-data">
    <div class="card mb-3 p-0">
        <div class="card-header fw-semibold px-4 py-3 bg-transparent">Grupo WhatsApp</div>
        <div class="card-body row px-4 py-3">
            <div class="mb-3">
                <div class="d-flex justify-content-between">
                    <label for="groupWhatsapp" class="form-label small">Link do Grupo</label>
                </div>
                <div class="input-group">
                    <input type="text" class="form-control" name="whatsapp_group" id="groupWhatsapp" aria-describedby="nameHelp" value="<?php echo @$shop['whatsapp_group']; ?>">
    ...
    <div class="container-save-button save fw-semibold bg-transparent d-flex align-items-center justify-content-between mb-3">
        <a href="<?php echo INCLUDE_PATH_DASHBOARD; ?>grupo-whatsapp" class="text-decoration-none text-reset">Cancelar</a>
...
<script>
    ...
    function colarURL() {
        ...
        if (navigator.clipboard) {
            navigator.clipboard.readText().then(function (text) {
                ...
                document.getElementById("groupWhatsapp").value = text;
            });
        } else {
    ...
    // Adicionar ouvinte de evento ao botão de colar
    document.getElementById("botaoColar").addEventListener("click", colarURL);
</script>
